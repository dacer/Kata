...
class BigBangActivity : AppCompatActivity(), KataLayout.ItemClickListener {
    ...
    private var searchAction: im.dacer.kata.core.action.SearchAction? = null
    ...
    private fun dealWithDictEntryList(dictEntryList: List<im.dacer.kata.core.model.DictEntry>): Observable<String> {
    ...
    private fun dealWithDictReadingList(dictReadingList: List<im.dacer.kata.core.model.DictReading>?): Observable<String> {
    ...
    private fun handleIntent(intent: Intent) {
        ...
        dictDb = im.dacer.kata.core.data.JMDictDbHelper(this).readableDatabase
        searchHelper = SearchHelper(dictDb!!)

        segmentDis?.dispose()
        segmentDis = im.dacer.kata.core.BigBang.getSegmentParserAsync()
        ...
        if(saveInHistory) im.dacer.kata.core.data.HistoryHelper.saveAsync(this, text, alias)
    }
