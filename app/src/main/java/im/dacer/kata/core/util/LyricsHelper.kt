...
object LyricsHelper {
     ...
     * page from 1
     */
    fun search(keywords: String, page: Int = 1): Observable<im.dacer.kata.core.model.MusicSearchResult.Result> {
        return Rx2AndroidNetworking.get(SEARCH_URL)
                ...
                .build()
                .getObjectObservable(im.dacer.kata.core.model.MusicSearchResult::class.java)
